...
#[no_mangle]
pub extern "C" fn sqlite3_open(filename: *const c_char, ppDb: *mut *mut Sqlite3) -> c_int {
    todo!()
}

#[no_mangle]
pub extern "C" fn sqlite3_open16(filename: *const c_void, ppDb: *mut *mut Sqlite3) -> c_int {
    todo!()
}

#[no_mangle]
pub extern "C" fn sqlite3_open_v2(filename: *const c_char, ppDb: *mut *mut Sqlite3, flags: c_int, zVfs: *const c_char) -> c_int {
    todo!()
}
