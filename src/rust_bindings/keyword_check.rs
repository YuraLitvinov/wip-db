...
#[no_mangle]
pub extern "C" fn sqlite3_keyword_name(code: c_int, str: *mut *const c_char, count: *mut c_int) -> c_int {
    todo!()
}

#[no_mangle]
pub extern "C" fn sqlite3_keyword_check(str: *const c_char, count: c_int) -> c_int {
    todo!()
}
