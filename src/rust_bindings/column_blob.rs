...
#[no_mangle]
pub extern "C" fn sqlite3_column_double(stmt: *mut sqlite3_stmt, iCol: c_int) -> c_double {
    todo!()
}

#[no_mangle]
pub extern "C" fn sqlite3_column_int(stmt: *mut sqlite3_stmt, iCol: c_int) -> c_int {
    todo!()
}

#[no_mangle]
pub extern "C" fn sqlite3_column_int64(stmt: *mut sqlite3_stmt, iCol: c_int) -> sqlite3_int64 {
    todo!()
}

#[no_mangle]
pub extern "C" fn sqlite3_column_bytes(stmt: *mut sqlite3_stmt, iCol: c_int) -> c_int {
    todo!()
}

#[no_mangle]
pub extern "C" fn sqlite3_column_bytes16(stmt: *mut sqlite3_stmt, iCol: c_int) -> c_int {
    todo!()
}

#[no_mangle]
pub extern "C" fn sqlite3_column_type(stmt: *mut sqlite3_stmt, iCol: c_int) -> c_int {
    todo!()
}
