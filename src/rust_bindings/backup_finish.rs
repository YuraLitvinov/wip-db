...
pub type Sqlite3Backup = c_void;

#[no_mangle]
pub extern "C" fn sqlite3_backup_step(p: *mut sqlite3_backup, nPage: c_int) -> c_int {
    todo!()
}

#[no_mangle]
pub extern "C" fn sqlite3_backup_finish(p: *mut sqlite3_backup) -> c_int {
    todo!()
}

#[no_mangle]
pub extern "C" fn sqlite3_backup_remaining(p: *mut sqlite3_backup) -> c_int {
    todo!()
}

#[no_mangle]
pub extern "C" fn sqlite3_backup_pagecount(p: *mut sqlite3_backup) -> c_int {
    todo!()
}
