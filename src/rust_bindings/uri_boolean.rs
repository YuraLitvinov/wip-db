...
#[no_mangle]
pub extern "C" fn sqlite3_uri_boolean(z: sqlite3_filename, zParam: *const c_char, bDefault: c_int) -> c_int {
    todo!()
}

#[no_mangle]
pub extern "C" fn sqlite3_uri_int64(file: sqlite3_filename, str: *const c_char, db: sqlite3_int64) -> sqlite3_int64 {
    todo!()
}
